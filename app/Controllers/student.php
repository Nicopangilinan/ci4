...
class Student extends Controller
{
    ...
    public function viewStudent($student_id) {
        $studentData = $this->student_model->getStudentData($student_id);
        if ($studentData) {
            echo json_encode(['status' => true, 'data' => $studentData]);
        } else {
            echo json_encode(['status' => false, 'message' => 'Student data not found']);
        }
    }
